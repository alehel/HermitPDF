...
export function SplitIcon({ className, style }: IconProps) {
  return (
    <svg
      className={className}
      width="16"
...
export function RotateLeftIcon({ className, style }: IconProps) {
  return (
    <svg
      className={className}
      width="16"
...
export function RotateRightIcon({ className, style }: IconProps) {
  return (
    <svg
      className={className}
      width="16"
...
export function CompactIcon({ className, style }: IconProps) {
  return (
    <svg
      className={className}
      width="16"
...
export function MergeIcon({ className, style }: IconProps) {
  return (
...
export function ExtractIcon({ className, style }: IconProps) {
  return (
    <svg className={className} width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={style}>
      <rect x="3" y="3" width="18" height="18" rx="2" ry="2" />
      <circle cx="8.5" cy="8.5" r="1.5" />
...
export function WorkbenchIcon({ className, style }: IconProps) {
  return (
    <svg className={className} width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={style}>
...
export function ArrowLeftIcon({ className, style }: IconProps) {
  return (
    <svg className={className} width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style}>
...
export function GripIcon({ className, style }: IconProps) {
  return (
    <svg className={className} width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" style={style}>
...
export function TrashIcon({ className, style }: IconProps) {
  return (
    <svg className={className} width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={style}>
...
export function FileDocIcon({ className, style }: IconProps) {
  return (
    <svg className={className} width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={style}>
      <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
      <polyline points="14 2 14 8 20 8" />
    </svg>
  );
...
export function UploadCloudIcon({ className, style }: IconProps) {
  return (
    <svg className={className} width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" style={style}>
...
export function RotateIcon({ className, style }: IconProps) {
  return (
    <svg className={className} width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={style}>
...
export function BatesIcon({ className, style }: IconProps) {
  return (
    <svg className={className} width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={style}>
      <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
      <polyline points="14 2 14 8 20 8" />
...
export function CodebergIcon({ className, style }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
